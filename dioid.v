...
(*                          replaced by T, and which is therefore             *)
(*                          a semiRingType structure on T. The sort carrier   *)
(*                          for cT must be convertible to T.                  *)
...
(*                          canonical pred_key is a semiRingPred.             *)
...
(*                          must have a dioidType canonical structure.        *)
...
(*              sup{ B } == the infinite sum operator for dioidtype on set B  *)
